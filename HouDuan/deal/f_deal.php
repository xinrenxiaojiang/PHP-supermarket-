...
*/
  ...
  if(isset($_POST['Submit'])||$_POST['Submit']=="新鲜水果"){
	  echo "<script> window.location.href='../pages/f1.php';</script>";
  }else  if(isset($_POST['Submit1'])||$_POST['Submit1']=="时令蔬菜"){
	  echo "<script> window.location.href='../pages/f2.php';</script>";
  }else  if(isset($_POST['Submit2'])||$_POST['Submit2']=="烟酒专区"){
	  echo "<script> window.location.href='../pages/f3.php';</script>";
  }else if(isset($_POST['Submit3'])||$_POST['Submit3']=="饮料专区"){
	  echo "<script> window.location.href='../pages/f4.php';</script>";
  }else if(isset($_POST['Submit4'])||$_POST['Submit4']=="运动专区"){
	  echo "<script> window.location.href='../pages/f5.php';</script>";
  }
