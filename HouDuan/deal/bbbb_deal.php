...
*/
  ...
  if(isset($_POST['Submit'])||$_POST['Submit']=="新鲜水果"){
	  echo "<script> window.location.href='../pages/aa.php';</script>";
  }else  if(isset($_POST['Submit1'])||$_POST['Submit1']=="时令蔬菜"){
	  echo "<script> window.location.href='../pages/bb.php';</script>";
  }else  if(isset($_POST['Submit2'])||$_POST['Submit2']=="烟酒专区"){
	  echo "<script> window.location.href='../pages/cc.php';</script>";
  }else if(isset($_POST['Submit3'])||$_POST['Submit3']=="饮料专区"){
	  echo "<script> window.location.href='../pages/dd.php';</script>";
  }else if(isset($_POST['Submit4'])||$_POST['Submit4']=="运动专区"){
	  echo "<script> window.location.href='../pages/ee.php';</script>";
  }
