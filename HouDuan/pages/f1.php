...
<table width="554" height="339" border="0" cellpadding="0" cellspacing="0" background="images/plsjgx.jpg" align="center">
  ...
  <tr>
    <td height="241">&nbsp;</td>
    <td align="left" valign="top"><form name="form1" method="post" action="../deal/f1_update_deal.php"><table width="452" height="50" border="1" cellpadding="0" cellspacing="0">
      <tr>
      ...
      <tr bordercolorlight="#FFFFFF">
        <td colspan="2" width="70" align="center" class="STYLE1">&nbsp;</td>
        <td colspan="3" width="224">
          <label for="textfield"></label></td>
        <td colspan="2" width="98"><input type="submit" name="Submit" id="button" value="批量删除" /></td>
    </tr>
